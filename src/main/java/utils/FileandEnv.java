	...
	public static Map<String, String> envAndFile() {
		...
		try {
			if (environment.equalsIgnoreCase("dev")) {
			    ...
			    fileandenv.put("Accept-Encoding", propMain.getProperty("Accept-Encoding"));
				fileandenv.put("Authorization", propMain.getProperty("Authorization"));
				 ...
				 * else if (environment.equalsIgnoreCase("staging")) { FileInputStream
				 * fisStaging = new FileInputStream(System.getProperty("user.dir") +
				 * "/inputs/staging.properties"); propMain.load(fisStaging);
				 * fileandenv.put("ServerUrl", propMain.getProperty("ServerUrl"));
